...
public class SmartTrafficModel{
        ...
        while(run){
            if(input.equalsIgnoreCase("exit")){
                ...
                if(input.equalsIgnoreCase("exit")){
                    ...
                    System.out.println("Commuting Time: " + measureCommutingTime(timeOfDay));
                    System.out.println("Gas Mileage: " + measureGasMileage());
                    System.out.println("Number of Accidents: " + measureNumberOfAccidents());
     ...
     */
    public static int measureCommutingTime(String timeOfDay){
     ...
     */
    public static int measureGasMileage(){
        int milesDriven = 25;
        int gasUsed;
        return milesDriven;
     ...
     */
    public static int measureNumberOfAccidents(){
        int numAccidents = 0;;
        return numAccidents;
